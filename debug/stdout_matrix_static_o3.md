Command: stdbuf -o0 -e0 ./bins/matrix_static_o3.o > >(tee stdout) 2> >(tee stderr >&2)

# stdout/stderr report: matrix_static_o3.o
...
Tempo gasto na execucao 0.460667 segundos
Digite o número desejados de threads a serem criadas (digite 0 para sair):
--> ```
